...
plot <- ggpar(plot,
    xlab = "Probe type",
    ylab = "Mean reaction time (log-transformed)")
plot
# ggexport(plot, width = 4, height = 4,
#     filename = here::here("Analysis/H1 Boxplot.pdf"))
```
...
# write.csv(multi, here::here("Analysis/multiverse.csv"))
```
...
plot
# ggexport(plot, width = 4, height = 4,
#     filename = here::here("Analysis/H1 Error Rate Boxplot.pdf"))
```
